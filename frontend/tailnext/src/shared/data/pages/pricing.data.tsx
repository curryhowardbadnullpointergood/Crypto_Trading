  ...
  prices: [
    {
      ...
      items: [
        {
          description: 'Access to a selection of professionally designed AI prompts.',
        },
        {
          description: 'Email support and AI automated trading.',
        },
        {
          description: 'Adequate API keys, and Social media integration.',
        },
        {
          description: 'Core features for a fully automated, and webscraping AI trading service.',
        },
      ],
      callToAction: {
        targetBlank: true,
    ...
    },
    {
      ...
      items: [
        {
          description: 'A larger variety of premium AI models to choose from.',
        },
        {
          description: 'Faster response times and priority customer support.',
        },
        {
          description: 'More storage space to accommodate growing trading context.',
        },
        {
          description: 'Enable automatic trades and option calls.',
        },
      ],
      callToAction: {
        targetBlank: true,
        text: 'Free 2 week trial',
        href: '/',
      },
      hasRibbon: true,
      ribbonTitle: 'Popular',
    },
    {
      ...
      items: [
        {
          description: 'Access to exclusive and customizable premium AI templates.',
        },
        {
          description: 'Round-the-clock customer support for immediate assistance.',
        },
        {
          description: 'No limits on storage, ideal for extensive large models and technical analysis.',
        },
        {
          description: 'Advanced LLMs, analytics, statistical models and reasoning abilities. ',
        },
      ],
      callToAction: {
        targetBlank: true,
